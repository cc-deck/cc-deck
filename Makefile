...
#
# Two components:
#   cc-zellij-plugin/  Rust WASM plugin for Zellij
#   cc-deck/           Go CLI that embeds the plugin
#
# Quick start:
#   make build          Build everything (WASM + CLI)
#   make install        Build and install plugin into Zellij
#   make test           Run all tests
#   make dev            Start Zellij dev layout for hot-reload
...
dev:  ## Start Zellij with hot-reload dev layout
	cd cc-zellij-plugin && zellij --layout zellij-dev.kdl
