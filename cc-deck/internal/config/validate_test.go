...
func TestIsEmoji(t *testing.T) {
	tests := []struct {
		...
		{"sun U+2600 is BMP, not emoji", 0x2600, false},
		{"snowman U+2603 is BMP, not emoji", 0x2603, false},
		{"scissors U+2702 is BMP, not emoji", 0x2702, false},
		{"gear U+2699 is BMP, not emoji", 0x2699, false},
		{"check mark U+2713 is BMP, not emoji", 0x2713, false},
		{"pencil U+270E is BMP, not emoji", 0x270E, false},
		{"ballot box U+2611 is BMP, not emoji", 0x2611, false},
