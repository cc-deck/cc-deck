...
// AllProjectWorkspaceNames returns a map of workspace name to project path
...
func (s *FileStateStore) AllProjectWorkspaceNames(excludePath string) (map[string]string, error) {
