...
* xref:plugin:overview.adoc[Plugin Guide] for all sidebar features and keybindings
* xref:plugin:configuration.adoc[Configuration] for personal layouts and Ghostty integration
