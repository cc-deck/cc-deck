...
Agent adapters declare their required domain groups (e.g., Claude declares `anthropic`, OpenCode declares `openai`), and the policy assembly resolves those groups to concrete endpoints automatically.
