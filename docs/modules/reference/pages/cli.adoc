...
[source,bash]
----
cc-deck ws kill mydev
cc-deck ws kill                    # resolves from project config
cc-deck ws kill --force --keep-volumes
----
...
cc-deck ws start                     # resolves from project config
----

==== ws stop

Gracefully stop a running workspace.

[source,bash]
----
cc-deck ws stop mydev
cc-deck ws stop                      # resolves from project config
----
...
Copy local files into a container workspace.
...
Copy files from a container workspace to the local machine.
...
Extract work products from a workspace.
Not supported for container workspaces (use push/pull instead).
