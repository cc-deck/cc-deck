...
cc-deck env create mydev --type ssh --host user@dev.example.com --repo https://github.com/org/repo.git
cc-deck env create mydev --type ssh --repo https://github.com/org/repo.git --branch develop
----
...
Display detailed status information for an environment.
For project-local environments, the output includes the project directory path.
