...
The build command automatically downloads cc-deck Linux binaries (amd64 + arm64) from GitHub Releases, matching your installed cc-deck version.
No manual cross-compilation is needed.
...
* `dnf` replaced with `microdnf` (fedora-minimal does not include full dnf)
