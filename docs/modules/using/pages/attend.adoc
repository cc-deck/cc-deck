...
Only Working sessions (actively generating output or calling tools) are included.
Waiting sessions are excluded since they need attention, which is `Alt+a`'s domain.
