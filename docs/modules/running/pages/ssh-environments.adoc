...
[source,bash]
----
cc-deck env create my-remote --type ssh --host user@host.example.com --workspace ~/projects
----
...
[source,bash]
----
cc-deck env exec remote-dev -- make test
----
...
[source,bash]
----
cc-deck env harvest remote-dev
----
...
[source,bash]
----
cc-deck env delete remote-dev --force
----
