...
[source,bash]
----
cc-deck env pull my-project /workspace/results ./local-results
----
...
Use `--keep-volumes` with `env delete` to preserve the PVC for potential reuse:

[source,bash]
----
cc-deck env delete my-project --force --keep-volumes
----
